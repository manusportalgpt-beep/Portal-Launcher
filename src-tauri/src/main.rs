...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Millida account auth — isolated from Microsoft/Ely.by
            commands::millida_auth::millida_login_init,
            commands::millida_auth::millida_login_poll,
            commands::millida_auth::millida_session_status,
            commands::millida_auth::millida_profile,
            commands::millida_auth::millida_friends_snapshot,
            commands::millida_auth::millida_upload_chat_file,
            commands::millida_auth::millida_send_friend_request,
            commands::millida_auth::millida_send_chat_message,
            commands::millida_auth::millida_remove_friend,
            commands::millida_auth::millida_logout,
            // Millida Hosting API — separate keyring namespace
            commands::hosting::millida_hosting_key_status,
            commands::hosting::millida_hosting_save_key,
            commands::hosting::millida_hosting_clear_key,
            commands::hosting::millida_hosting_get_server,
            commands::hosting::millida_hosting_get_status,
            commands::hosting::millida_hosting_start,
            commands::hosting::millida_hosting_stop,
            commands::hosting::millida_hosting_restart,
            commands::hosting::millida_hosting_get_console,
            commands::hosting::millida_hosting_list_files,
            commands::hosting::millida_hosting_get_backups,
            commands::hosting::millida_hosting_create_backup,
            commands::hosting::millida_hosting_command,
            // Token manager
