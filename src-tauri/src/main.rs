...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Вход через браузер с выбором аккаунта удалён: требовал ручной
            // Client ID/Redirect URI. Остался вход по коду подтверждения.
    ...
    commands::opencode::op_write_bytes,
            ...
            // Aternos — бесплатный хостинг Minecraft-серверов
            commands::aternos::aternos_login,
            commands::aternos::aternos_login_with_session,
            commands::aternos::aternos_login_with_token,
            commands::aternos::aternos_logout,
            commands::aternos::aternos_list_servers,
            commands::aternos::aternos_server_info,
            commands::aternos::aternos_start,
            commands::aternos::aternos_stop,
            commands::aternos::aternos_restart,
            commands::aternos::aternos_confirm,
            commands::aternos::aternos_accept_eula,
            commands::aternos::aternos_set_motd,
            commands::aternos::aternos_set_subdomain,
            commands::aternos::aternos_files,
            commands::aternos::aternos_download_file,
            commands::aternos::aternos_upload_file,
            commands::aternos::aternos_create_server,
            commands::aternos::aternos_watch_set,
            commands::aternos::aternos_console_open,
            commands::aternos::aternos_console_command,
            commands::aternos::aternos_console_close,
            commands::aternos::aternos_afk_set,
        ])
