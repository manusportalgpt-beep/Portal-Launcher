...
export function FirstLaunchExperience() {
  ...
  return <AnimatePresence><motion.div className="clean-onboarding fixed inset-0 z-[230] overflow-y-auto" style={{ background:'var(--color-bg)', color:'var(--color-text)' }} initial={{ opacity:0 }} animate={{ opacity:1 }}>
    <motion.section className="clean-onboarding-surface portal-glass-surface portal-glass-outline flex min-h-screen w-full flex-col" style={{ background:'var(--color-bg)', border:'0 solid var(--color-border)', borderRadius:0, boxShadow:'none' }} initial={{ opacity:0, y:12 }} animate={{ opacity:1, y:0 }}>
